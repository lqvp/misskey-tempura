...
export type AdminRootAdd = operations['admin___root___add']['requestBody']['content']['application/json'];
export type AdminRootRemove = operations['admin___root___remove']['requestBody']['content']['application/json'];
...
export type FollowingRequestsSendListRequest = operations['following___requests___send___list']['requestBody']['content']['application/json'];
export type FollowingRequestsSendListResponse = operations['following___requests___send___list']['responses']['200']['content']['application/json'];
