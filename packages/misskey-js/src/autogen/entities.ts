...
export type ReactionStatRequest = operations['reaction-stat']['requestBody']['content']['application/json'];
export type ReactionStatResponse = operations['reaction-stat']['responses']['200']['content']['application/json'];
