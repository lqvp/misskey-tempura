...
export type FollowingRequestsSendlistRequest = operations['following___requests___sendlist']['requestBody']['content']['application/json'];
export type FollowingRequestsSendlistResponse = operations['following___requests___sendlist']['responses']['200']['content']['application/json'];
