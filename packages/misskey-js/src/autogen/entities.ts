...
export type AdminRootAddRequest = operations['admin___root___add']['requestBody']['content']['application/json'];
export type AdminRootRemoveRequest = operations['admin___root___remove']['requestBody']['content']['application/json'];
...
export type NotesAnyLocalTimelineRequest = operations['notes___any-local-timeline']['requestBody']['content']['application/json'];
export type NotesAnyLocalTimelineResponse = operations['notes___any-local-timeline']['responses']['200']['content']['application/json'];
export type NotesFollowingsUpdatesRequest = operations['notes___followings-updates']['requestBody']['content']['application/json'];
export type NotesFollowingsUpdatesResponse = operations['notes___followings-updates']['responses']['200']['content']['application/json'];
