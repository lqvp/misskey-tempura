...
<div>
	...
	<div class="_spacer" style="--MI_SPACER-min: 20px; --MI_SPACER-max: 32px;">
		<form class="_gaps_m" autocomplete="new-password" @submit.prevent="onSubmit">
			<MkInput v-if="showInvitationCodeInput" v-model="invitationCode" type="text" :spellcheck="false" :required="instance.disableRegistration" data-testid="signup-invitation-code">
			...
			<MkInput v-show="instance.emailRequiredForSignup && !props.skipEmailAuth" v-model="email" :debounce="true" type="email" :spellcheck="false" data-testid="signup-email" @update:modelValue="onChangeEmail">
