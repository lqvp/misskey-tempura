...
<div v-if="instance" :class="$style.root">
	...
	<div v-if="instance.entranceShowStats && stats && instance.clientOptions.showActivitiesForVisitor !== false" :class="$style.stats">
	...
	<div v-if="instance.policies.ltlAvailable && instance.clientOptions.showTimelineForVisitor !== false && instance.entranceShowTimeLine" :class="[$style.tl, $style.panel]">
		<div :class="$style.tlHeader">{{ i18n.ts.letsLookAtTimeline }}</div>
		<div :class="$style.tlBody">
			<MkStreamingNotesTimeline src="local"/>
		</div>
	</div>
	<div v-if="instance.clientOptions.showActivitiesForVisitor !== false && instance.entranceShowStats" :class="$style.panel">
		<XActiveUsersChart/>
	</div>
</div>
</template>
