...
const onlyOnOrOffNotificationTypes = ['app', 'achievementEarned', 'login', 'loginFailed', 'createToken', 'cleanupDanglingFollowsCompleted'] satisfies (typeof notificationTypes[number])[] as string[];
