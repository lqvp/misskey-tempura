...
import type { AvatarDecorationMutingsRepository, MiQuoteMuting } from '@/models/_.js';
...
@Injectable()
export class AvatarDecorationMutingEntityService {
	constructor(
	...
	@bindThis
	public async pack(
		src: MiAvatarDecorationMuting['id'] | MiAvatarDecorationMuting,
		me?: { id: MiUser['id'] } | null | undefined,
		hints?: {
			packedMutee?: Packed<'UserDetailedNotMe'>
		},
	): Promise<Packed<'AvatarDecorationMuting'>> {
		const muting = typeof src === 'object' ? src : await this.avatarDecorationMutingsRepository.findOneByOrFail({ id: src });
	...
	public async packMany(
		mutings: MiAvatarDecorationMuting[],
		me: { id: MiUser['id'] },
	) {
