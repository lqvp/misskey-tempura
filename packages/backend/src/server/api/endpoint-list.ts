...
export * as 'drive/files/create-multipart-upload' from './endpoints/drive/files/create-multipart-upload.js';
export * as 'drive/files/upload-multipart-part' from './endpoints/drive/files/upload-multipart-part.js';
export * as 'drive/files/complete-multipart-upload' from './endpoints/drive/files/complete-multipart-upload.js';
...
export * as 'admin/federation/followers' from './endpoints/admin/federation/followers.js';
export * as 'admin/federation/following' from './endpoints/admin/federation/following.js';
...
export * as 'admin/send-notification' from './endpoints/admin/send-notification.js';
...
export * as 'roles/add' from './endpoints/roles/add.js';
export * as 'roles/assign' from './endpoints/roles/assign.js';
...
export * as 'i/cleanup-dangling-follows' from './endpoints/i/cleanup-dangling-follows.js';
