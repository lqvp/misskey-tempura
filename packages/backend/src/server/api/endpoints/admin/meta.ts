...
const DEFAULT_OPEN_LLM_MODERATION_VISIBILITIES = [
	"public",
	"public_non_ltl",
	"home",
	"followers",
...
export default class extends Endpoint<typeof meta, typeof paramDef> {
	...
	constructor(
		...
		super(meta, paramDef, async () => {
			...
			const normalizedOpenLlmModerationVisibilities = Array.isArray(
				instance.openLlmModerationVisibilities,
			)
				? instance.openLlmModerationVisibilities.filter(
						(
							visibility,
						): visibility is (typeof DEFAULT_OPEN_LLM_MODERATION_VISIBILITIES)[number] =>
							DEFAULT_OPEN_LLM_MODERATION_VISIBILITIES.includes(
								visibility as (typeof DEFAULT_OPEN_LLM_MODERATION_VISIBILITIES)[number],
							),
					)
				: null;
			const openLlmModerationVisibilities =
			...
			return {
				...
				openLlmModerationApiConfigured:
					instance.openLlmModerationApiKey != null,
				openLlmModerationIncludeRemote:
					instance.openLlmModerationIncludeRemote ?? false,
				openLlmModerationVisibilities,
				...
				blockMentionsFromUnfamiliarRemoteUsers:
					instance.blockMentionsFromUnfamiliarRemoteUsers,
