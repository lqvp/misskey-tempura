...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			if (
				(!ps.moderationNote || moderationNoteBefore === ps.moderationNote) &&
				(quarantineLimited === undefined || isQuarantineLimitBefore === quarantineLimited) &&
				(!suspensionState || isSuspendedBefore === ps.isSuspended)
			) {
