...
export class AddOidc1781487680852 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "user_oidc_link" ("id" varchar(32) PRIMARY KEY NOT NULL, "userId" varchar(32) NOT NULL, "provider" varchar(128) NOT NULL, "providerUserId" varchar(1024) NOT NULL, "createdAt" timestamp with time zone NOT NULL)`);
        await queryRunner.query(`CREATE INDEX "IDX_user_oidc_link_userId" ON "user_oidc_link" ("userId")`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_user_oidc_link_provider_providerUserId" ON "user_oidc_link" ("provider", "providerUserId")`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_user_oidc_link_provider_providerUserId"`);
